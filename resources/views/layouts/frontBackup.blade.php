        ...
        <div class="top-header-group">
            <div class="top-header">
                <div class="res_main_logo">
                    <a href="{{route('home')}}"><img src="{{asset('front/images/dark-logo-1.svg')}}" alt=""></a>
                </div>
                <div class="main_logo" id="logo">
                    <a href="{{route('home')}}"><img src="{{asset('front/images/logo.svg')}}" alt=""></a>
                    <a href="{{route('home')}}"><img class="logo-inverse" src="{{asset('front/images/dark-logo.svg')}}" alt=""></a>
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu"
                            ...
                            <ul class="navbar-nav main_nav align-self-stretch">
                                <li class="nav-item"><a href="{{route('home')}}" class="nav-link active" title="Home">Home</a>
                                </li>
    ...
    <div class="wrapper">
        ...
        <div class="all-product-grid">
            <div class="container-fluid">
                ...
                <div class="product-list-view mt-0">
                    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <ul class="call-email-alt">
                            ...
                            <li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="f49d9a929bb4939599969b87818491869995869f9180da979b99">[email&#160;protected]</span></a></li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="second-row-item-app">
                            ...
                            <ul>
                                <li>
                                    <a href="#"><img class="download-btn" src="{{asset('front/images/download-1.svg')}}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img class="download-btn" src="{{asset('front/images/download-2.svg')}}" alt=""></a>
                                </li>
                            </ul>
                        </div>
